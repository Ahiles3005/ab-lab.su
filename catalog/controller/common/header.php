...
class ControllerCommonHeader extends Controller {
	...
	public function index() {
		...
		$data['phoneHeader'] = $this->progroman_city_manager->getMessage('phoneHeader');
		$data['addresLine1'] = $this->progroman_city_manager->getMessage('addresLine1');
		$data['addresLine2'] = $this->progroman_city_manager->getMessage('addresLine2');
		$data['emails'] = $this->progroman_city_manager->getMessage('email');
...
$children_data[] = array('name'  => $child['name'] . ($this->config->get('config_product_count') ? ' (' . $this->model_catalog_product->getTotalProducts($filter_data) . ')' : ''),'href'  => $this->url->link('product/category', 'path=' . $category['category_id'] . '_' . $child['category_id'], true));
